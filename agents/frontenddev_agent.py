...
from tools.mcp_tools import MCP_CONTEXT7_TOOLS
...
FRONTENDDEV_TOOLS = [design_component_architecture, audit_performance, generate_accessibility_report] + list(MCP_CONTEXT7_TOOLS)
